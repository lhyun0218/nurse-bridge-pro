  ...
  return (
    ...
    >
      ...
      <div style={{ ...cardBase, borderTopColor: '#C0392B' }}>
        <div style={{ fontSize: '11px', color: '#6B8090', fontWeight: 500, marginBottom: '6px' }}>
          위험 환자 (High)
        </div>
        <div style={{ fontSize: '24px', fontWeight: 700, color: '#C0392B' }}>
          {highCount}명
        </div>
        <div style={{ fontSize: '11px', color: '#6B8090', marginTop: '3px' }}>
          즉시 확인 필요
        </div>
      </div>
      ...
      <div style={{ ...cardBase, borderTopColor: '#2C6E8A' }}>
        ...
        <div style={{ fontSize: '24px', fontWeight: 700, color: '#2C6E8A' }}>
          {rate}%
        </div>
        <div style={{ fontSize: '11px', color: '#6B8090', marginTop: '3px' }}>
          {completed} / {total} 완료
